...
const styles = "tap-scale inline-flex min-h-12 items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-black transition focus:outline-none focus:ring-2 focus:ring-lime-300 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50";
const variants = {
  primary: "bg-lime-400 text-zinc-950 shadow-[0_10px_24px_rgba(132,204,22,0.22)] hover:bg-lime-300",
  dark: "bg-zinc-950 text-white shadow-[0_12px_28px_rgba(24,24,27,0.22)] hover:bg-zinc-800",
  ...
  purple: "bg-purple-50 text-purple-950 hover:bg-purple-100",
